    ...
    <main className="min-h-screen bg-[#0d0e1a] flex items-center justify-center p-6 text-white">
      <div className="w-full max-w-md bg-[#121422] border border-white/10 rounded-3xl p-8 shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">Sign in to BIM Cloud to access your projects.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl pl-11 pr-4 py-3 text-sm focus:border-blue-500 outline-none transition-all"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-blue-600/20 flex justify-center items-center gap-2 mt-4 disabled:opacity-50"
          >
