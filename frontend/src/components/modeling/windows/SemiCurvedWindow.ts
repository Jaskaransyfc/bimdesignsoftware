...
export const renderSemiCurvedWindow = (
  scene: THREE.Scene,
  x: number,
  z: number,
  ...
  // Horizontal bar
  addPart(new THREE.BoxGeometry(winW - 2*fw, grillThickness, 0.02), "frame", 0, -winH/2 + rectHeight, 0);
  // Vertical bars
  addPart(new THREE.BoxGeometry(grillThickness, rectHeight - fw, 0.02), "frame", -winW/4, -winH/2 + fw + (rectHeight - fw)/2, 0);
  addPart(new THREE.BoxGeometry(grillThickness, rectHeight - fw, 0.02), "frame", winW/4, -winH/2 + fw + (rectHeight - fw)/2, 0);
  addPart(new THREE.BoxGeometry(grillThickness, rectHeight - fw, 0.02), "frame", 0, -winH/2 + fw + (rectHeight - fw)/2, 0);
